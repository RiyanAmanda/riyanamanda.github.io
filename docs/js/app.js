...
try {
  window.AOS = __webpack_require__(/*! aos */ "./node_modules/aos/dist/aos.js"); // Mengambil tinggi body pada browser

  var tinggi = $(window).height() / 2; // Membuat fungsi scroll ditampilkan Tombol Back-top
